...
app.get("/api/quote", async (req, res) => {
  try {
    ...
    const body = {
      contents: [
        { parts: [{ text: "Give me a short, original motivational quote to inspire and reward someone with, who just finished studying but needs to still study more. Make it simple and lil funny so they catchy. No formatting of any sorts, I just want the quote." }] }
      ]
    };
